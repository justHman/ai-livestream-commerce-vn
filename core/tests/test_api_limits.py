...
from core.api.limits import MaxBodySizeMiddleware, SlidingWindowLimiter
...
def test_exact_vietnamese_emoji_boundaries_are_accepted() -> None:
    from core.api.v1 import AvatarCreateReq, ChatIn, PlanCreateReq, SayReq
...
def test_author_max_plus_one_is_rejected() -> None:
    from core.api.v1 import ChatIn
...
def test_persona_max_plus_one_is_rejected() -> None:
    from core.api.v1 import PlanCreateReq
...
def test_url_max_plus_one_is_rejected() -> None:
    from core.api.v1 import AvatarCreateReq
...
def test_say_max_plus_one_is_rejected() -> None:
    from core.api.v1 import SayReq
...
def test_comment_batch_over_limit_is_rejected() -> None:
    from core.api.v1 import IngestReq
...
def test_comment_text_over_limit_is_rejected() -> None:
    from core.api.v1 import CommentIn
