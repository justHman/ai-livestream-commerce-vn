...
from backend.observability.logging.config import LoggingConfig as _LoggingConfig
...
class TestSetup:
    ...
    def test_setup_failure_closes_created_handlers(self) -> None:
        ...
        with (
            ...
            patch("backend.observability.logging.setup.ActiveSessionHandler") as mock_active,
        ):
...
class TestStructureParity:
    ...
    def test_all_services_have_observability(self) -> None:
        ...
        for svc in ("backend_service", "llm_service", "tts_service", "avatar_service"):
