"""backend.api.v1.voices — runtime LLM/TTS engine management + TTS preview.

Copied from ``core/api/v1/voices.py`` (COPY-DON'T-IMPORT, Task 1.25);
...
from .router import router, TTSPresetIn, TTSPreviewReq, logger, rate_limit_admin
...
async def preview_tts(
    ...
    from tts.engines.base import TTSRequest
