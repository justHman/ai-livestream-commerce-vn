"""Scope-based authorization for the avatar service."""

from __future__ import annotations

from fastapi import Depends, HTTPException, status

from avatar.api.security.authentication import get_auth_subject

SERVICE_SCOPES = frozenset({"avatar.render", "avatar.admin"})
ADMIN_SCOPES = frozenset({"avatar.admin", "avatar.contracts", "avatar.health"})
