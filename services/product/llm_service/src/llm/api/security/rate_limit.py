"""Rate and concurrency limiting — CPU and GPU-aware request limiting.

GPU concurrency is deliberately strict (typically 1) so a self-host engine
on one GPU never receives overlapping heavyweight requests. Both limiters are
token-bucket style counters with bounded capacity.
"""
