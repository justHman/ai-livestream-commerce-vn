...
## Purpose
Provider-neutral TTS serving runtime: transparent cross-session dynamic micro-batching on GPU, VieNeu v3 Turbo as first provider, tenant-scoped voice profiles/cloning, fairness/priority/backpressure, content-private observability, and multi-session load verification. Created by archiving change multi-session-batched-tts-runtime (PASS 2026-08-12).
