# adaptive-speech-text-chunking Specification

## Purpose
Source-agnostic speech text segmentation for the streaming pipeline: deterministic Vietnamese boundary scoring, real streaming deadline, exactly-once finality, and an adaptive policy gated by a real-TTS benchmark. Created by archiving change adaptive-speech-text-chunking (PASS 2026-08-12).
