...
- [x] 17.2 Run provider contract tests on pinned VieNeu GPU runtime for preset, clone, mixed voice, mixed style, expressive cues, and output order/count.
...
- [x] 17.4 Run direct-provider and service benchmark gates and record relative service throughput against direct provider.
...
- [x] 17.9 Record final capacity report with hardware, provider/model revision, scheduler configuration, voice mix, concurrency, throughput, queue wait, GPU/VRAM, and overload/error results.
