...
```json
{
  "mappings": [
    ...
    {"category": "product/backend", "source": "providers/liveavatar_cloud/service/", "target": "services/product/backend_service/src/backend/application/clients/avatar/liveavatar.py and tests/sandbox/liveavatar/"},
    ...
    {"category": "support/benchmarks", "source": "scripts/bench_api.py", "target": "benchmarks/api/latency.py"},
    {"category": "support/benchmarks", "source": "scripts/benchmark_commerce_clustering.py", "target": "benchmarks/backend/commerce_clustering.py"},
    {"category": "support/benchmarks", "source": "scripts/benchmark_stage2.py", "target": "benchmarks/backend/stage2_pipeline.py"},
    {"category": "support/infra", "source": "scripts/stage_smoke.ps1", "target": "infra/scripts/staging_smoke.ps1"},
    {"category": "support/infra", "source": "scripts/teardown_verify.ps1", "target": "infra/scripts/teardown_verify.ps1"},
    {"category": "support/infra", "source": "scripts/swap_task_image.py", "target": "infra/scripts/swap_task_image.py"},
    {"category": "support/llm", "source": "scripts/gen_vllm_modelinfo_cache.py", "target": "services/product/llm_service/scripts/"},
    {"category": "support/shared", "source": "scripts/upload_weights_s3.py", "target": "scripts/model_assets/upload.py"},
    {"category": "support/shared", "source": "services/scripts/fetch_weights.sh", "target": "scripts/model_assets/fetch_weights.sh"},
